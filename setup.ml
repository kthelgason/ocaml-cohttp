...
(* OASIS_START *)
(* DO NOT EDIT (digest: 33ca0ff7dac2c1071c23a805be9ed89a) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_sanity",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_sanity", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_async_integration",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_async_integration", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              })
       ];
     doc =
       [
          ...
          ("cohttp_lwt_core",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lwt-core"});
          ("cohttp_lwt",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "lwt"});
          ("cohttp_async",
            OCamlbuildDocPlugin.doc_build
              {OCamlbuildDocPlugin.extra_args = []; run_path = "async"})
       ];
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/mirage/ocaml-cohttp";
          synopsis = "HTTP library for Lwt, Async, JavaScript and Mirage";
          description =
            Some
              [
                 OASISText.Para
                   "CoHTTP is an OCaml library for creating HTTP clients and daemons.  It has a portable HTTP parser.  Optional dependencies activate functionality:";
                 OASISText.Verbatim "* Lwt: `opam install lwt cohttp`";
                 OASISText.Verbatim
                   "* Lwt and SSL: `opam install lwt ssl cohttp`";
                 OASISText.Verbatim "* Async: `opam install async cohttp`";
                 OASISText.Verbatim
            ...
            [
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("uri",
                               Some (OASISVersion.VGreaterEqual "1.5.0"));
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build everything that is possible";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "build the Lwt-unix library";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "all", true)
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the Javascript XHR client library";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "all", true)
               ...
               Flag
                 ({
                     cs_name = "async_s3_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      flag_description = Some "build the async s3 example";
                      flag_default =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EFlag "all", true)
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "lwt-core";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "cohttp_lwt";
                           FindlibPackage ("unix", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage
                             ("conduit.lwt-unix",
                               Some (OASISVersion.VGreaterEqual "0.7.0"));
               ...
               Library
                 ({
                  ...
                  },
                   {
                      bs_build =
                        [
                           (OASISExpr.EBool true, false);
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "lwt", OASISExpr.EFlag "js"),
                             true)
                        ];
                      bs_install =
                        [
                   ...
                   {
                      lib_modules = ["Cohttp_lwt_xhr"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "js";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Cohttp_async_io"; "Cohttp_async"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Cohttp_lwt_unix_test"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "lwt-unix-test";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "cohttp_async_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Cohttp_async_test"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "cohttp";
                      lib_findlib_name = Some "async-test";
                      lib_findlib_containers = []
                   });
               Doc
                 ({
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_install = [(OASISExpr.EBool true, true)];
                      doc_install_dir = "$docdir";
                      doc_title = "Cohttp Lwt core docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     cs_name = "test_net_lwt_google_custom_ctx";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_net_lwt_google_custom_ctx.ml"
                   });
               Executable
                 ({
                     cs_name = "test_net_lwt_lastminute";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_net_lwt_lastminute.ml"
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                     cs_name = "test_net_lwt_multi_get";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_net_lwt_multi_get.ml"
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_net_async_http10.ml"
                   });
               Executable
                 ({
                     cs_name = "test_net_async_multi_get";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_net_async_multi_get.ml"
                   });
               Executable
                 ({
               ...
               Executable
                 ({
                     cs_name = "test_async_integration";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [InternalLibrary "cohttp_async_test"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "test_async_integration.ml"
                   });
               Executable
                 ({
                     cs_name = "cohttp-server-async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "cohttp_server_async.ml"
                   });
               Executable
                 ({
                     cs_name = "cohttp-curl-async";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "cohttp_curl_async.ml"
                   });
               Executable
                 ({
                     cs_name = "cohttp-server-lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cmdliner",
                               Some (OASISVersion.VGreaterEqual "0.9.4"))
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                   ...
                   {exec_custom = true; exec_main_is = "cohttp_server_lwt.ml"
                   });
               Executable
                 ({
                     cs_name = "cohttp-proxy-lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "cohttp_proxy_lwt.ml"});
               Executable
                 ({
                     cs_name = "cohttp-curl-lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "cohttp_curl_lwt.ml"});
               Executable
                 ({
                     cs_name = "async-hello-world";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "hello_world.ml"});
               Executable
                 ({
                     cs_name = "async-s3-cp";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      bs_build =
                        [
                           ...
                           (OASISExpr.EAnd
                              (OASISExpr.EFlag "async",
                                OASISExpr.EFlag "async_s3_example"),
                             true)
                        ];
                      bs_install = [(OASISExpr.EBool true, false)];
                      bs_path = "examples/async";
                   ...
                   {exec_custom = true; exec_main_is = "s3_cp.ml"});
               Executable
                 ({
                     cs_name = "test_xhr";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "cohttp";
                           InternalLibrary "cohttp_lwt_xhr";
                           FindlibPackage ("js_of_ocaml.ppx", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = true; exec_main_is = "test_xhr.ml"});
               Executable
                 ({
                     cs_name = "async-receive-post";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "receive_post.ml"});
               Executable
                 ({
                     cs_name = "client_lwt_doc_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "client_lwt.ml"});
               Executable
                 ({
                     cs_name = "server_lwt_doc_example";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = true; exec_main_is = "server_lwt.ml"});
               Executable
                 ({
                     cs_name = "test_sanity";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "cohttp";
                           InternalLibrary "cohttp_lwt_unix_test";
                           FindlibPackage ("lwt.unix", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = true; exec_main_is = "test_sanity.ml"});
               Test
                 ({
                     cs_name = "test_accept";
                     cs_data = PropList.Data.create ();
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      ...
                      src_repo_browser =
                        Some "https://github.com/mirage/ocaml-cohttp";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "D`\138ô.¿R·Qy\019óV/\012\130";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
